...
# PBJ Runtimes have by default 3 entries in sys.argv, non-PBJ Runtimes have only 1
default_argv_len = 3 if os.environ.get("ML_RUNTIME_METADATA_VERSION", "1") == "2" else 1

# A JSON dataset is pointed to by path.
# The path can be either a single text file or a directory storing text files.
if len(sys.argv) == default_argv_len:
    path = "hdfs://" + \
